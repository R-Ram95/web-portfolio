...
function About(){
    ...
    return(
        <div className="hero is-fullheight" css={css`background-color: rgb(29, 28, 26);`}>
        <div className="columns is-centered is-vcentered py-6" id="about">
                ...
                <div className="column has-text-left is-half">
                    <div className="box" css={css`border-radius: 25px;`}>
                    <div className="content">
                        ...
                        <p className='is-size-4 is-family-monospace is-1 has-text-justified'>
                            ...
                            I love all things tech with a particularly keen
                            interest in full stack development. Checkout my projects to learn more about my work, and
